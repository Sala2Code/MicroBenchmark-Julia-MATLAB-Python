...
# Utilisation de vecteurs statiques et mutables (SVector et MVector)
# Typage de certaines variables (typé à l'aide de @code_warntype pour voir les types non inférés)
