...
function LapParaSym(Mat11,Mat12,Mat21,Mat22, Dx, Dy, Nxy)
    ...
    # view permet d'éviter de copier la tableau initial (temps d'allocation) en travaillant sur le tableau initial via des pointeurs
    return sparse(view(V,1,1:iCpt-1), view(V,2,1:iCpt-1), view(V,3,1:iCpt-1), Nx*Ny, Nx*Ny)
end
