...
# Utilisation d'une structure plutôt que d'un dictionnaire
# Modification de nombreuses fonctions en fonctions mutables ( Fun!() ) dans Lap.jl
...
function main()
    ...
    Mat = LapOrtho + LapPara/epsilon # Typage
